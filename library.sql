/* Disclaimer: This database, created by Joshua Asante, demonstrates SQL proficiency.
   Except for information reltaion to authors, the data presented is fictional and not
...
INSERT INTO authors (author_name, nationality, birth_date)
VALUES
...
-- I have chosen to make the starting value for the borrowing_id 5000 -- 

ALTER TABLE borrowings
AUTO_INCREMENT = 5000;

-- Inserting values into the borrowings table--
